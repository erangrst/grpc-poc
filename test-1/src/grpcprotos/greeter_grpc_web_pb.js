 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.helloworld.HelloRequest2,
 *   !proto.helloworld.HelloReply>}
 */
const methodDescriptor_Greeter_SayHello2 = new grpc.web.MethodDescriptor(
  '/helloworld.Greeter/SayHello2',
  grpc.web.MethodType.UNARY,
  proto.helloworld.HelloRequest2,
  proto.helloworld.HelloReply,
  /**
   * @param {!proto.helloworld.HelloRequest2} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
...
/**
 * @param {!proto.helloworld.HelloRequest2} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.helloworld.HelloReply)}
 ...
 *     The XHR Node Readable Stream
 */
proto.helloworld.GreeterClient.prototype.sayHello2 =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/helloworld.Greeter/SayHello2',
      request,
      metadata || {},
      methodDescriptor_Greeter_SayHello2,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.helloworld.GreeterPromiseClient.prototype.sayHello2 =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/helloworld.Greeter/SayHello2',
      request,
 ...
 *     The XHR Node Readable Stream
 */
proto.helloworld.GreeterClient.prototype.sayHelloStream =
    function(request, metadata) {
 ...
 *     The XHR Node Readable Stream
 */
proto.helloworld.GreeterPromiseClient.prototype.sayHelloStream =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/helloworld.Greeter/SayHelloStream',
      request,
